...
const skills: Skill[] = [
	{ name: 'Php', level: 100, years: 5},
	{ name: 'JavaScript', level: 100, years: 5 },
	{ name: 'SQL', level: 100, years: 5 },
	{ name: 'RESTful APIs', level: 100, years: 5 },
	{ name: 'Laravel', level: 100, years: 5 },
	{ name: 'Bootstrap', level: 100, years: 5},
	{ name: 'Git', level: 100, years: 5 },
	{ name: 'JQuery', level: 100, years: 5 },
	{ name: 'Shell Commands', level: 100, years: 5 },
	{ name: 'CodeIgniter 4', level: 60, years: 3 },
	{ name: 'Wordpress', level: 40, years: 2 },
	{ name: 'Symfony', level: 40, years: 2 },
	{ name: 'React', level: 40, years: 2 },
	{ name: 'VueJs', level: 40, years: 2 },
	{ name: 'NodeJs', level: 40, years: 2 },
	{ name: 'TypeScript', level: 20, years: 1 },
	{ name: 'Docker', level: 20, years: 1 },
];
								...
								<div className="flex flex-wrap sm:flex-nowrap justify-between mb-2 gap-2">
									<div className="flex flex-wrap sm:flex-nowrap items-center gap-2">
										...
										<div className="flex flex-wrap sm:flex-nowrap gap-1">
											{skill.name === 'Php' && (
												<span className="px-2 py-0.5 text-xs rounded-full bg-blue-500/10 text-blue-400 border border-blue-500/20">+4 Frameworks</span>
											)}
											{skill.name === 'JavaScript' && (
												<span className="px-2 py-0.5 text-xs rounded-full bg-orange-500/10 text-orange-400 border border-orange-500/20">+5 Libraries </span>
											)}
											{skill.name === 'SQL' && (
												<span className="px-2 py-0.5 text-xs rounded-full bg-green-500/10 text-green-400 border border-green-500/20">Advanced Queries</span>
											)}
											{skill.name === 'RESTful APIs' && (
												<span className="px-2 py-0.5 text-xs rounded-full bg-purple-500/10 text-purple-400 border border-purple-500/20">+10 Different API Services</span>
											)}
										</div>
									</div>
									<span className="text-blue-400 opacity-0 group-hover:opacity-100 transition-opacity">{skill.years} Years</span>
								</div>
